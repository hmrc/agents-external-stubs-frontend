...
object Menus {
  ...
  val menu1 = Seq(item1, item2, item3, item6)
  val menu2 = Seq(item1, item2, item3, item4, item6)
  val menu3 = Seq(item1, item2, item3, item5, item6)
  val menu4 = Seq(item1, item2, item3, item4, item5, item6)
